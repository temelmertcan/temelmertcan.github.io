...
<p> <b> Quick  start with VeSCmul</b>.  A small package  with a few examples
 showing how to  run VeSCmul is given  <a href="vescmul.zip">here</a>. This
 is most useful when using VeSCmul for new designs. This package includes a
 README file  to guide  you through the  installation and  execution steps.
 </p>
